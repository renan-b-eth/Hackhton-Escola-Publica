...
const team: TeamMember[] = [
    ...
    },
    {
        ...
        hackathons: [
            ...
            { icon: ShieldCheck, name: "Hackathon Devs de Impacto (RJ)", year: "2025" },
            { icon: Cpu, name: "Hackathon Devs de Impacto (Online)", year: "2025" },
            { icon: Leaf, name: "Hackathon Devs de Impacto (Curitiba)", year: "2025" },
